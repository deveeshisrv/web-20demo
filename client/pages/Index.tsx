            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Dr. Chhavi specializes in comprehensive Ayurvedic medicine
                  focused on identifying and treating the underlying causes of
                  illness. Through systematic constitutional analysis and
                  time-tested therapeutic protocols, we address the source of
                  health imbalances for lasting healing.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Dr. Chhavi operates a professional medical practice specializing
              in Ayurvedic medicine. With over 10 years of clinical experience,
              the practice employs standardized diagnostic protocols and
              evidence-based treatment modalities for comprehensive patient
              care.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                The practice employs systematic diagnostic methodologies
                including constitutional assessment (Prakriti), pathological
                evaluation (Vikriti), pulse diagnosis (Nadi Pariksha), and
                comprehensive clinical examination to determine precise
                etiopathological factors underlying disease manifestation.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Treatment protocols are formulated according to classical
                Ayurvedic principles using standardized herbal formulations,
                panchakarma therapeutic procedures, and targeted interventions
                designed to eliminate disease causation and restore optimal
              ...
              <div className="grid sm:grid-cols-2 gap-6 pt-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Advanced Tridosha assessment and pathological imbalance
                      identification
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Systematic elimination of disease causation through
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-6 transition-all duration-300 hover:scale-105 hover:shadow-xl group cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Advanced studies in Panchakarma & Herbology
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 transition-all duration-300 hover:scale-105 hover:shadow-xl group cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Pulse Diagnosis & Constitutional Analysis
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 transition-all duration-300 hover:scale-105 hover:shadow-xl group cursor-pointer">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-2">
                  Gastroenterology & Panchakarma Therapeutics
                </p>
                <p className="text-sm text-muted-foreground">
                  Reproductive Health, Neuropsychological Disorders
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Schedule your medical consultation for comprehensive diagnostic
              evaluation and treatment planning. Dr. Chhavi provides
              professional Ayurvedic medical services with systematic root cause
              analysis and clinical therapeutic protocols.
            </p>
          </div>
            ...
            <Card className="p-8 transition-all duration-300 hover:shadow-2xl bg-primary/5 border-primary/20">
              <div className="text-center space-y-6">
                ...
                <p className="text-lg text-muted-foreground">
                  Contact Dr. Chhavi's medical practice to schedule your
                  clinical consultation and discuss professional Ayurvedic
                  treatment options for your medical condition.
                </p>

                <div className="space-y-4">
                  <a href="tel:+15551234567" className="block w-full">
                    <Button
                      size="lg"
                  ...
                  <p className="text-sm text-muted-foreground">
                    Direct access to Dr. Chhavi's medical practice - clinical
                ...
                <div className="pt-4 border-t border-primary/20">
                  <p className="text-sm text-muted-foreground">
                    <strong>Clinic availability:</strong> Monday-Friday 8:00 AM
                    - 6:00 PM, Saturday 9:00 AM - 2:00 PM
                  </p>
                </div>
              </div>
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Professional medical practice specializing in clinical Ayurvedic
              medicine and root cause treatment protocols.
            </p>
            <div className="text-sm text-muted-foreground">
